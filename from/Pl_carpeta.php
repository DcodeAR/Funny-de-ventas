...
$dia=strftime("%Y/%m/%d");
	...
	$query=mysqli_query($conexion,"SELECT * from tusuario WHERE Usuario='".$_SESSION['username']."'");
	...
	echo "<tr>";
	echo '<td colspan="20"><input type="submit" onclick="timeF()" id="guardar" name="guardar" style="margin-left:10px; margin-top:10px" value="Guardar"/><br/></td>';
	echo "</tr>";
