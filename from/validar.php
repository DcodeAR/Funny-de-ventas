...
<script>
    function timeI() {
        ...
        document.cookie = "inicioValidacion="+horas+":"+minutos+":"+segundos;
    }
	...
	function timeF() {
        ...
        var minutos = today.getUTCMinutes()
		var segundos = today.getUTCSeconds()
        document.cookie = "finalValidacion="+horas+":"+minutos+":"+segundos;
    }
</script>
...
$FechaCierre=$_POST['FechaCierre'];
	...
	echo "</table><br>";
	echo '<a  href="?pagina=Pm_carpeta_alerta">Volver </a>';
	echo '<a  href="?pagina=logout"> Cerrar Sesión</a>';
	echo "</from>";
} 
...
if(isset($_POST['cerrar'])){
	...
	$query2="INSERT INTO tiempovalidacion VALUES(TIMEDIFF('".$_COOKIE["final"]."','".$_COOKIE["inicial"]."'),
		'".$_COOKIE["inicial"]."',
		'".$_COOKIE["final"]."',
		'".$IdUsuario."'
		)";
...
// 	echo "</table>";
	    ...
	    while ($fila2=mysqli_fetch_array($usuario)) 
        	{
        		...
        		."</td>"
        		.'<td><a onclick="timeI()" href="javascript:Opena('.$fila2['IdCarpeta'].')"><img src="img/editar.png"></img></a></td>'
        		."<td><a onclick='timeF();' href=?pagina=CRUD_Carpeta&IdCarpeta=".$fila2['IdCarpeta']."&Envio=Envio><img src='img/enviar.png'></a></td>"
        		."</tr>"			
        		."</tbody>";	
        	    }
        	    else{
        		...
        		."</td>"
        		.'<td><a href="javascript:Opena('.$fila2['IdCarpeta'].')"><img src="img/editar.png"></img></a></td>'
        		."<td><a href=?pagina=CRUD_Carpeta&IdCarpeta=".$fila2['IdCarpeta']."&Envio=Envio><img src='img/enviar.png'></a></td>"
        		."</tr>"			
        		."</tbody>";
        	    }
            }
	...
	echo '<td><input type="submit" onclick="timeF()" id="regresar" name="regresar" value="Regresar" target="_blank">';
	echo '<td><input type="submit" id="cerrar" name="cerrar" value="Cerrar Sesión" target="_blank">';
...
$IdConsultor=$_POST['IdConsultor'];
	...
	echo '<a href="?pagina=Pm_carpeta_alerta">Regresar </a>';
	echo '<a href="?pagina=logout">Cerrar Sesión</a>';
