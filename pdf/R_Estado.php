...
$pdf->Cell(0,60,'BASE CUENTAS LIBRES',0,0,'C');
$pdf->Ln(5);
$pdf->Cell(196);
...
while ($row=mysqli_fetch_array($usuario))
{
      ...
      $pdf->Cell(2);
        ...
        $pdf->Cell(70, 5,''.utf8_decode($row['Empresa']), 1);
        ...
        $pdf->Cell(19, 5,''.utf8_decode($row['Usuario'])." ".utf8_decode($row['ApellidoP']), 1);
        $pdf->Ln(5);
